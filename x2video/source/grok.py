...
def _build_prompt(
    ...
    *,
    ...
    return (
        ...
        f"  {kw}\n\n"
        "ONLY keep posts whose MAIN topic is AI, large language models, developer "
        "tools, or tech-industry news. Drop posts that merely mention a keyword, "
        "unrelated jokes, sports, politics, or accounts that happen to have AI in "
        "the display name.\n"
        "Prefer English or Chinese posts with a clear information payload "
        "(a launch, a benchmark, a paper, a product change, a substantive take).\n"
        ...
        "media_urls should be image URLs when possible, not video playlists.\n"
